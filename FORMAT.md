...
either would have its files overwritten. Don't name a category `INPUTS`,
`Pending`, or `Unsorted`, and don't point a `destination` at `DEADLINES.md`,
`TASKS.md`, or inside any of `INPUTS/`, `Pending/`, `Unsorted/`.
